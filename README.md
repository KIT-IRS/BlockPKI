...
The system structure is described in the thesis, the individual functions have docstrings with an additional autogenerated callmap through go. These are written before each function and in a callmap
